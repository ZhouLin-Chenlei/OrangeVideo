...
public class Validator {
     ...
     * 正则表达式：不包含某些字符
     */
    public static final String REGEX_SPECIAL = "^[^@#：:]\\S$";
     ...
     * 正则表达式：验证全是数字
     */
    public static final String REGEX_NUM = "^[0-9]{4,8}$";
    /**
     * 正则表达式：验证手机号
     */
...
//    public static final String REGEX_URL = "http(s)?://([\\w-]+\\.)+[\\w-]+(/[\\w- ./?%&=]*)?";
    ...
    public static boolean isNickName(String nickname) {
        return Pattern.matches(REGEX_SPECIAL, nickname);
    }
    /**
     * 校验全是数字
     * 
     ...
     * @return 校验通过返回true，否则返回false
     */
    public static boolean isAllNum(String username) {
...
//    	String regex = "[\u4e00-\u9fa5]";
    	...
    	for(int i = 0;i < length;i++){
    		boolean matches = isChinese(str.charAt(i)+"");
    		if(matches){
    			amount++;
    		}
    	}
